...
import com.fuiou.mchnt.entry.constants.FtpConstants;
import com.fuiou.mchnt.entry.util.FtpUtil;
import com.fuiou.mchnt.entry.util.IsLinuxUtil;
...
public class FtpDownload
{
    ...
    public boolean isRemoteDir()
    {
        ...
        String remoteDir = remoteDownloadFilePath.substring(0,remoteIndex + 1);
        String fileName = new File(remoteDownloadFilePath).getName();
        try
        {
            //判定目录是否存在
