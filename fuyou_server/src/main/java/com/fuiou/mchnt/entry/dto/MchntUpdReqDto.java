...
public class MchntUpdReqDto extends BaseReqDto {
	...
	private String th_flag = "";//退货标记(0:不能退货,1:可以退货)
	private String wx_flag = "";  //微信支付标识(0：关闭微信,1：开通微信)
	private String wx_edit_flag = "";  //微信商户简称修改标识(0：不修改,1：修改)
    ...
    public String getWx_edit_flag() {
        return wx_edit_flag;
    }
    public void setWx_edit_flag(String wx_edit_flag) {
        this.wx_edit_flag = wx_edit_flag;
    }
