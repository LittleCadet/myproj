...
public class MergeQr {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /*File file = new File("D:\\download\\聚合收款码-扫码进入微信小程序.png");
            //二维码上传到Oss
            ...
            //从oss下载文件到本地
            OSS ossClient = new OSSClientBuilder().build("oss-cn-hangzhou.aliyuncs.com", "LTAI4Ff6LjbrgESvCDR9w8Xg", "rTTwoDhDe4dFpBN3JlIqDXdicRMNUl");
            ossClient.getObject(new GetObjectRequest("facepay-test","聚合收款码-扫码进入微信小程序.png" ), new File("C:\\Users\\Administrator\\Desktop\\image\\oss.jpg"));
